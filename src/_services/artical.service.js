...
function getById(id) {
    ...
    return fetch(`${apiUrl}/singlearticalget/${id}`, requestOptions).then(handleResponse);
}
...
function update(user) {
    ...
    return fetch(`${apiUrl}/singlearticalupdate/${user.id}`, requestOptions).then(handleResponse);;
}
